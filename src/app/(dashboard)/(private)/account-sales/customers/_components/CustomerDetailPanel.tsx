...
import type { AccountOrderDto, MemberDto, SellerBonusProgressDto, SalesBonusTransactionDto } from '@/generated/core-api'
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
          ...
          <Box>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 0.5 }}>
              <Typography variant='h4' fontWeight={800}>
                {selectedMember.displayName || 'Unnamed member'}
              </Typography>
              <Chip
                size='small'
                label='VIP MEMBER'
      ...
      <Box sx={{ minHeight: 400 }}>
        ...
        {detailTab === 'commission' && <CustomerCommissionTab memberId={selectedMember.id ?? null} />}
        ...
        {detailTab === 'staff-notes' && (
          <Box sx={{ p: 4, bgcolor: 'action.hover', border: '1px solid', borderColor: 'divider', borderRadius: 3 }}>
            ...
            {selectedMember.customerNote ? (
              <Box
                sx={{ p: 3, bgcolor: 'background.paper', borderRadius: 2, border: '1px solid', borderColor: 'divider' }}
              >
