...
const loginGlobalStyles = (
  <GlobalStyles
    styles={{
      ...
      '[data-mui-color-scheme="light"] .login-bg-icon, :not([data-mui-color-scheme="dark"]) .login-bg-icon': {
        opacity: 0.05
      },
      ...
      '[data-mui-color-scheme="light"] .login-bg-icon--check, :not([data-mui-color-scheme="dark"]) .login-bg-icon--check':
        { opacity: 0.03 },
    ...
    >
      ...
      <Box
        sx={theme => ({
          ...
          borderRadius: 2,
          boxShadow:
            theme.palette.mode === 'dark' ? '0 25px 50px -12px rgba(0, 0, 0, 0.25)' : '0 10px 30px rgba(0, 0, 0, 0.08)',
          p: { xs: 4, sm: 5 },
          maxWidth: 450,
          width: '100%'
        })}
      ...
      <div className='login-footer'>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, opacity: 0.8 }}>
          ...
          <Typography
            variant='caption'
            sx={{ textTransform: 'uppercase', letterSpacing: '0.1em', fontFamily: 'inherit' }}
          >
    ...
    return (
      <CardWrapper>
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <Typography
            className='login-fade-in login-heading'
            variant='h5'
            fontWeight={600}
            sx={{ color: 'text.primary', mb: 1, fontFamily: 'inherit' }}
          >
            See You Soon!
          </Typography>

          <Typography
            className='login-fade-in-d2 login-subtext'
            variant='body2'
            sx={{ color: 'text.secondary', mb: 4, textAlign: 'center', fontFamily: 'inherit' }}
          >
          ...
          <div className='login-fade-in-d4' style={{ width: '100%', paddingTop: 8 }}>
            <Button
              ...
              startIcon={
                isSigningIn ? <i className='tabler-loader-2 animate-spin' style={{ fontSize: 20 }} /> : undefined
              }
    ...
    <CardWrapper>
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 4 }}>
        ...
        <Typography
          ...
          variant='h5'
          fontWeight={600}
          sx={{ color: 'text.primary', mb: 1.5, letterSpacing: '-0.02em', fontFamily: 'inherit' }}
        >
          Project Alfred
        </Typography>
        <div
          className='login-fade-in-d2'
          style={{
            display: 'flex',
            alignItems: 'center',
            gap: 8,
        ...
        >
          ...
          <Typography
            variant='caption'
            fontWeight={600}
            sx={{ color: '#7367f0', letterSpacing: '0.05em', textTransform: 'uppercase', fontFamily: 'inherit' }}
          >
            Secure SSO Only
          </Typography>
        </div>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
        <div className='login-fade-in-d3' style={{ textAlign: 'center' }}>
          ...
          <Typography
            ...
            variant='body2'
            sx={{ color: 'text.secondary', lineHeight: 1.6, fontFamily: 'inherit' }}
          >
        ...
        <div
          className='login-fade-in-d5'
          style={{ position: 'relative', display: 'flex', alignItems: 'center', padding: '8px 0' }}
        >
          <div className='login-divider' style={{ flexGrow: 1, borderTop: '1px solid', borderColor: 'inherit' }} />
          <Typography
            className='login-divider-text'
            variant='caption'
            sx={{ mx: 2, color: 'text.disabled', fontFamily: 'inherit' }}
          >
            Enterprise Security
          </Typography>
          <div className='login-divider' style={{ flexGrow: 1, borderTop: '1px solid', borderColor: 'inherit' }} />
        ...
        <div
          className='login-fade-in-d6'
          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 24, paddingTop: 8 }}
        >
          <button
            type='button'
            style={{
