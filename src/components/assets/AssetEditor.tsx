...
import type { AttachmentDto, CategoryTreeNodeDto } from '@generated/api'
...
const EVENT_TYPES = [
  { value: 'Maintain', label: 'Maintenance', icon: 'tabler-settings-2', color: '#4caf50' },
  { value: 'Repair', label: 'Repair', icon: 'tabler-tool', color: '#ff9800' },
  { value: 'Refill', label: 'Refill', icon: 'tabler-gas-station', color: '#2196f3' },
] as const
