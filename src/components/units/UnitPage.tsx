...
import { useGetApiV1UnitsCountsByCategory, useGetApiV1UnitsCountsByStatus } from '@generated/api'
...
const UnitPage = () => {
  ...
  const { data: statusCounts } = useGetApiV1UnitsCountsByStatus()
  const { data: categoryCounts } = useGetApiV1UnitsCountsByCategory()
