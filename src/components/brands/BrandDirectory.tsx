...
import { useGetApiV1Brands, useGetApiV1Categories } from '@generated/api'
...
const BrandDirectory = () => {
  ...
  const { data: categoriesData, isLoading: loadingCategories } = useGetApiV1Categories({
    filter: "type == 'Brand'",
    pageSize: 100,
    sort: 'name'
  })
  ...
  const { data, isLoading } = useGetApiV1Brands({
    page,
    pageSize,
    filter,
    sort: '-createdAt',
