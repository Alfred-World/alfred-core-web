...
import type { CommodityDto } from '@generated/api'
...
const CommodityDirectory = () => {
  ...
  const { data: metalData } = useGetApiV1Commodities({ page: 1, pageSize: 1, filter: metalFilter })
  const { data: forexData } = useGetApiV1Commodities({ page: 1, pageSize: 1, filter: forexFilter })
  const { data: stockData } = useGetApiV1Commodities({ page: 1, pageSize: 1, filter: stockFilter })
  ...
  // ─── Main data ──────────────────────────────────────────────────────────────
  const { data, isLoading } = useGetApiV1Commodities({ page, pageSize, filter, sort: 'code' })
